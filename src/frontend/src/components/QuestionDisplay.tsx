        ...
        {OPTION_LABELS.map((label, idx) => {
          ...
          return (
            <button
              ...
              className={`w-11 h-11 rounded-lg border-2 font-bold text-sm transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-navy/40 flex items-center justify-center shrink-0 ${
                isSelected
